...
void LoginScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginScreen::*)(QString , QString )>(_a, &LoginScreen::loginAttempt, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LoginScreen::*)(QString , QString )>(_a, &LoginScreen::registerAttempt, 1))
            return;
    }
}
